...
void *writer(void *arg) {
    ...
    waiting_writers++;
    sem_wait(&wrt);  // Writer waits for semaphore to write
    waiting_writers--;
    
    shared_data += 10;  // Example: Modify shared resource
...
// Display function for current status of readers and writers
void display_status() {
    printf("\n--- Current Status ---\n");
...
int main() {
    ...
    while (1) {
        ...
        sleep(1);  // Wait to allow threads to execute
    }
